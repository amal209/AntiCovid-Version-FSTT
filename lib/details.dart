...
import 'Statistics/fcm_manager.dart';
          ...
          child: Padding(
            ...
            child: Center(
              child: Column(
                ...
                SfCircularChart(
                  title:
                  ChartTitle(text: 'Interactive statistics of Corona virus'),
                  legend:
                  ...
                  series: <CircularSeries>[
                    ...
                    SfCircularChart(
                      title:
                      ChartTitle(text:'_________Tests by Population_________'),
                      legend:
                      Legend(isVisible: true, overflowMode: LegendItemOverflowMode.wrap),
...
void Statistic(BuildContext context) {
  final route = MaterialPageRoute(builder: (BuildContext context) {
    return const MyStatisticsPage(title: "STATISTICS");
  });
  Navigator.of(context).push(route);
}
